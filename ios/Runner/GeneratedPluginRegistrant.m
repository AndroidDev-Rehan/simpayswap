...
#if __has_include(<flutter_toast_message/FlutterToastMessagePlugin.h>)
#import <flutter_toast_message/FlutterToastMessagePlugin.h>
#else
@import flutter_toast_message;
#endif
...
#if __has_include(<passbase_flutter/PassbaseFlutterPlugin.h>)
#import <passbase_flutter/PassbaseFlutterPlugin.h>
#else
@import passbase_flutter;
#endif
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [FlutterToastMessagePlugin registerWithRegistrar:[registry registrarForPlugin:@"FlutterToastMessagePlugin"]];
  [FluttertoastPlugin registerWithRegistrar:[registry registrarForPlugin:@"FluttertoastPlugin"]];
  [FLTLocalAuthPlugin registerWithRegistrar:[registry registrarForPlugin:@"FLTLocalAuthPlugin"]];
  [PassbaseFlutterPlugin registerWithRegistrar:[registry registrarForPlugin:@"PassbaseFlutterPlugin"]];
